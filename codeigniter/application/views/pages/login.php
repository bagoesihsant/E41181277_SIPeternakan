              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?php echo base_url('admin/cekLogin');?>">
                    ...
                    <input type="submit" value="Login" name="loginSubmit" class="btn btn-success btn-user btn-block">
                  </form>
                  <hr>
                  <div class="text-center">
                  ...
                  <div class="text-center">
                    <a class="small text-success" href="<?php echo base_url('admin/register');?>">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
